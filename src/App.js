...
import { updateAuthUserData } from './actions/reduxActions';
            ...
            if (user === null) {
                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        let user_data = user;
                        user_data.tokenRedeemed =
                            response.data.user_info.token_redeemed;
                ...
                <Router>
                    ...
                    {this.props.current_video_data && (
                        <MiniatureVideo
                            ...
                            currentTime={
                                !thumbInfo ? null : thumbInfo.currentTime
                            }
                            currentVolume={
                                !thumbInfo ? null : thumbInfo.currentVolume
                            }
                            isThumbnailActive={
                                !thumbInfo ? null : thumbInfo.thumbnail
                            }
