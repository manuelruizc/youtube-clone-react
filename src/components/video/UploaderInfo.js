...
class UploaderInfo extends Component {
    ...
    getPlaylistsIncludingVideo = async (uid, databasePlaylists) => {
        ...
        this.setState({
            playlistsIncludingVideo: playlists,
            databasePlaylists,
        });
    };
    ...
    modalPlaylist = (close = true) => {
        if (close)
            this.setState({ isModalPlaylist: false, isModalPrivacy: false });
            ...
            <React.Fragment>
                ...
                >
                    <div className="image-container">
                        ...
                        <div
                            className={
                                isSubscribed ? 'sub-btn unsub' : 'sub-btn'
                            }
                        ...
                        >
                            {isSubscribed
                                ? locales.uploaderInfo.subscribeButton
                                      .subscribed
                                : locales.uploaderInfo.subscribeButton
                                      .unsubscribed}
                        </div>
