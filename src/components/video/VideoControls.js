...
import { toggleAutoplay, toggleTheaterMode } from "../../actions/darkTheme";
import {
  FullScreen,
  MaxVolume,
  MinVolume,
    ...
    return (
      <>
        <div
          ...
          style={{ opacity: !videoIsPlaying || isCogActive ? 1 : hide ? 0 : 1 }}
          onMouseEnter={() =>
            document
        ...
        >
          ...
          >
            <span style={{ left: x }} className="hover-time" ref={hoverTime}>
              {currentHoveredTime}
            </span>
            <input
              id="range"
              ...
              value={range.current ? range.current.value : sliderThumbPosition}
            ...
            <div className="slider-video-progress">
              <div
                style={{
                  width:
                    (100 / this.props.duration) * this.props.currentTime + "%",
                  height: "100%",
                }}
              />
            </div>
          ...
          <div className="buttons-bottom">
            <div className="buttons-left-container">
              ...
              <div className="volume-container">
                <div onClick={muteVideo} style={{ marginRight: 10 }}>
                  {VolumeIcon}
                </div>
            ...
            <div className="buttons-right-container">
              <span onClick={(e) => this.changeCogState(e)}>
                <ToolTip
                  message={locales.videoPlayer.tooltips.controls.settings}
                  show={!this.state.isCogActive}
                  videoControl
                >
                  <i
                    className={`fa fa-cog ${
                      this.state.isCogActive ? "cog-rotate" : ""
                    }`}
                  ></i>
                </ToolTip>
              </span>
              ...
              >
                <ToolTip
                  videoControl
                  message={locales.videoPlayer.tooltips.controls.mini}
                >
                  <PictureInPicture />
                </ToolTip>
              </span>
                ...
                <ToolTip
                  ...
                  message={
                    this.props.theaterMode
                      ? locales.videoPlayer.tooltips.controls.theaterMode.active
                      : locales.videoPlayer.tooltips.controls.theaterMode
                          .unactive
                  }
                >
                  <MovieSvg />
              ...
              >
                <ToolTip
                  videoControl
                  message={locales.videoPlayer.tooltips.controls.fullscreen}
                >
                  <FullScreen />
                </ToolTip>
              </span>
