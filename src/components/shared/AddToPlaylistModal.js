...
import { addToastNotification } from '../../actions/reduxActions';
...
class AddToPlaylistModal extends Component {
    ...
    getPlaylistsIncludingVideo = async (uid, database_playlists) => {
        ...
        this.setState({
            playlists_including_video: playlists,
            database_playlists,
        });
    };
    ...
    checkboxChanged = async (e, index) => {
        ...
        if (checkbox.checked) {
            ...
            const response = await addVideoToExistingPlaylist(
                uid,
                video_object
            );
            ...
            const response = await deleteVideoFromExistingPlaylist(
                uid,
                video_object
            );
            if (response.status === 200) {
            ...
            >
                ...
                <div className="playlist-form-container">
                    ...
                    <div className="playlist-scroll">
                        {this.state.database_playlists.map(
                            (playlist, index) => {
                                ...
                                if (
                                    ...
                                    _playlistName =
                                        locales.customPlaylists[_playlistName];
                                return (
                                    <label key={index}>
                                        <div
                                            className={
                                        ...
                                        <input
                                            ...
                                            onChange={
                                                isParentAThumbnail
                                                    ? (e) =>
                                                          this.checkboxChangedRelatedVideo(
                                                              e,
                                                              index
                                                          )
                                                    : (e) =>
                    ...
                    {this.state.playlistNameActive ? (
                        <NewPlaylistForm
                            ...
                            isPrivacyOptionActive={
                                this.state.isPrivacyOptionActive
                            }
