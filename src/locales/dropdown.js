...
const locales = {
    ca: {
        ...
        appareance: {
            ...
            light: 'Tema clar',
            descriptionOne:
                'Aquest tema enfosqueix les zones de llum de la pàgina i proporciona una experiència nocturna ideal.',
            descriptionTwo:
                "La configuració del tema fosc només s'aplicarà en aquest navegador.",
        },
        language: {
            title: 'Idioma',
    ...
    de: {
        ...
        appareance: {
            ...
            light: 'Helles Design',
            descriptionOne:
                'Dieses Thema verdunkelt die hellen Bereiche der Seite und bietet ein ideales Abenderlebnis.',
            descriptionTwo:
                'Ihre dunklen Themeneinstellungen werden nur in diesem Browser angewendet.',
        },
        language: {
            title: 'Sprache',
    ...
    en: {
        ...
        appareance: {
            ...
            light: 'Light theme',
            descriptionOne:
                'This theme darkens the light areas of the page, providing an ideal evening experience.',
            descriptionTwo:
                'Your dark theme settings will only be applied in this browser.',
        },
        language: {
            title: 'Language',
    ...
    es: {
        ...
        appareance: {
            ...
            light: 'Tema claro',
            descriptionOne:
                'Este tema oscurece las áreas claras de la página, proporcionando una experiencia nocturna ideal.',
            descriptionTwo:
                'La configuración de su tema oscuro solo se aplicará en este navegador.',
        },
        language: {
            title: 'Idioma',
    ...
    it: {
        ...
        appareance: {
            ...
            light: 'Tema chiaro',
            descriptionOne:
                "Questo tema scurisce le aree chiare della pagina, offrendo un'esperienza serale ideale.",
            descriptionTwo:
                'Le impostazioni del tuo tema scuro verranno applicate solo in questo browser.',
        },
        language: {
            title: 'Lingua',
